...
return new class extends Migration
{
    ...
    {
        Schema::create('ocean_export_containers', function (Blueprint $table) {
            $table->id();
            $table->foreignId('ocean_export_id')->constrained('ocean_exports')->onDelete('cascade');
            ...
            $table->index(['ocean_export_id', 'container_no']);
        });
    }
    ...
    {
        Schema::dropIfExists('ocean_export_containers');
    }
};
