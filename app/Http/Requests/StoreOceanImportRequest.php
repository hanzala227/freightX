...
class StoreOceanImportRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            // Core
            'file_no' => 'required|string|max:255|unique:ocean_imports,file_no',
            'mbl_no' => 'nullable|string|max:255|unique:ocean_imports,mbl_no',
