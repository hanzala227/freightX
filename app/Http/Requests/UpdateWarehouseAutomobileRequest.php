...
class UpdateWarehouseAutomobileRequest extends FormRequest
{
    ...
    {
        $id = $this->route('warehouse_automobile') ? $this->route('warehouse_automobile')->id : null;

        return [
            'vin_no' => 'required|string|max:50|unique:warehouse_automobiles,vin_no,' . $id,
