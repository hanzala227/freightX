...
class UpdateTruckShipmentRequest extends FormRequest
{
    ...
    {
        $id = $this->route('truck_shipment') ? $this->route('truck_shipment')->id : null;

        return [
            'file_no' => 'required|string|unique:truck_shipments,file_no,' . $id,
